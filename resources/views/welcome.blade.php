...
<head>
    ...
    <meta name="keywords"
        content="hostel management software, pg management system, dorm management saas, bed occupancy tracking, hostel billing automation, hostelease">
    ...
    <style>
        ...
        .hero-section {
            ...
            overflow: hidden;
            padding-top: 140px;
            /* Increased to account for floating navbar */
        }
...
<body>
    ...
    <nav class="navbar-glass">
        <div class="d-flex justify-content-between align-items-center w-100">
            ...
            <div>
                <a href="{{ route('login') }}"
                    class="btn btn-link text-white text-decoration-none fw-semibold me-2">Login</a>
    ...
    <section class="hero-section">
        ...
        <div class="container hero-content text-center">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <span
                        class="badge bg-white bg-opacity-10 text-white rounded-pill px-4 py-2 mb-4 fw-semibold tracking-wider text-uppercase"
                    ...
                    <p class="lead text-white opacity-75 mb-5 mx-auto"
                        style="max-width: 700px; font-size: clamp(1rem, 2vw, 1.25rem);">
                        The ultra-premium SaaS platform designed to streamline bed assignments, automate rent
                        collection, and provide powerful real-time insights for hostel and PG owners.
                    </p>
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        <a href="{{ route('register') }}" class="btn btn-neon btn-lg"><i
                                class="fa-solid fa-rocket me-2"></i> Start Your Free Trial</a>
            ...
            <div class="row justify-content-center mt-5 pt-4">
                <div class="col-lg-11 col-xl-10 px-2 px-md-4">
                    <div class="position-relative mx-auto shadow-lg overflow-hidden"
                        style="border-radius: 20px; border: 1px solid rgba(255,255,255,0.15); transform: perspective(1200px) rotateX(8deg) translateY(20px); box-shadow: 0 50px 100px -20px rgba(0,0,0,0.7); background: #f8fafc;">
                        ...
                        <div class="bg-dark d-flex align-items-center px-3 py-2" style="height: 32px;">
                            ...
                            <div class="mx-auto text-white opacity-50 small"
                                style="font-size: 0.7rem; font-weight: 500;">app.hostelease.com</div>
                        </div>
                        ...
                        <div class="d-flex text-start" style="height: 500px; max-height: 60vh;">
                            ...
                            <div class="bg-white border-end d-none d-md-flex flex-column p-3" style="width: 220px;">
                                <div class="d-flex align-items-center gap-2 mb-4">
                                    <div class="rounded border bg-primary text-white d-flex align-items-center justify-content-center fw-bold"
                                        style="width: 28px; height: 28px; font-size: 0.8rem;">H</div>
                                    <span class="fw-bold fs-6 text-dark">HostelEase</span>
                                </div>
                                <div class="d-flex flex-column gap-2">
                                    <div class="p-2 bg-primary bg-opacity-10 text-primary rounded-3 fw-semibold small">
                                        <i class="fa-solid fa-chart-pie me-2"></i> Dashboard</div>
                                    <div class="p-2 text-secondary rounded-3 fw-semibold small"><i
                                            class="fa-solid fa-bed me-2"></i> Bed Matrix</div>
                                    <div class="p-2 text-secondary rounded-3 fw-semibold small"><i
                                            class="fa-solid fa-users me-2"></i> Students</div>
                                    <div class="p-2 text-secondary rounded-3 fw-semibold small"><i
                                            class="fa-solid fa-file-invoice-dollar me-2"></i> Billing</div>
                                </div>
                            </div>
                            ...
                            <div class="flex-grow-1 bg-light p-4 overflow-hidden d-flex flex-column">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="d-flex gap-3 align-items-center">
                                        <div class="bg-white rounded-pill px-3 py-1 shadow-sm small text-muted border">
                                            <i class="fa-solid fa-magnifying-glass me-2"></i> Search...</div>
                                        <div class="rounded-circle bg-secondary bg-opacity-25"
                                    ...
                                    <div class="col-4">
                                        <div class="bg-white p-3 rounded-4 shadow-sm border h-100">
                                            <div class="text-muted small text-uppercase fw-bold mb-1"
                                                style="font-size: 0.65rem;">Total Revenue</div>
                                            <div class="fw-bold text-dark" style="font-size: 1.1rem;">₹4,52,000</div>
                                            <div class="text-success small fw-semibold" style="font-size: 0.7rem;"><i
                                                    class="fa-solid fa-arrow-up"></i> 12%</div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="bg-white p-3 rounded-4 shadow-sm border h-100">
                                            <div class="text-muted small text-uppercase fw-bold mb-1"
                                                style="font-size: 0.65rem;">Occupancy</div>
                                            <div class="fw-bold text-dark" style="font-size: 1.1rem;">94%</div>
                                            <div class="text-primary small fw-semibold" style="font-size: 0.7rem;">
                                                141/150 Beds</div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="bg-white p-3 rounded-4 shadow-sm border h-100">
                                            <div class="text-muted small text-uppercase fw-bold mb-1"
                                                style="font-size: 0.65rem;">Pending Dues</div>
                                            <div class="fw-bold text-dark" style="font-size: 1.1rem;">₹18,500</div>
                                            <div class="text-danger small fw-semibold" style="font-size: 0.7rem;">12
                                                Students</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex gap-3 flex-grow-1">
                                    <div class="bg-white rounded-4 shadow-sm border flex-grow-1 p-3 d-flex flex-column">
                                        ...
                                        <div class="flex-grow-1 d-flex align-items-end gap-2 px-2 pb-2">
                                            <div class="bg-primary bg-opacity-10 rounded-top flex-grow-1"
                                                style="height: 30%"></div>
                                            <div class="bg-primary bg-opacity-25 rounded-top flex-grow-1"
                                                style="height: 50%"></div>
                                            <div class="bg-primary bg-opacity-50 rounded-top flex-grow-1"
                                                style="height: 40%"></div>
                                            <div class="bg-primary bg-opacity-75 rounded-top flex-grow-1"
                                                style="height: 70%"></div>
                                            <div class="bg-primary rounded-top flex-grow-1"
                                                style="height: 90%; box-shadow: 0 -5px 15px rgba(79, 70, 229, 0.4);">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="rounded-circle bg-success bg-opacity-10 text-success d-flex align-items-center justify-content-center"
                                                    style="width:24px;height:24px;font-size:0.6rem;"><i
    ...
    <section id="features" class="py-5" style="background: #f8fafc; margin-top: -100px; padding-top: 200px !important;">
        <div class="container">
            <div class="text-center mb-5 pb-3">
                ...
                <p class="text-muted lead mx-auto" style="max-width: 600px;">Stop using spreadsheets. Discover the
                    powerful tools designed specifically for modern hostel operators.</p>
            </div>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <p class="text-muted mt-3">Monitor live occupancy across all your rooms and floors with our
                            stunning, interactive capacity dashboard. Never double-book a bed again.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <p class="text-muted mt-3">Generate invoices, track pending fees, and process payments securely.
                            Our automated ledger handles the math so you can focus on growth.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <p class="text-muted mt-3">Make data-driven decisions with real-time revenue analytics,
                            collection charts, and detailed reports that give you a 360° view of your business.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5 bg-white">
        <div class="container py-5">
            <div class="text-center mb-5 pb-3">
                ...
                <p class="text-muted lead mx-auto" style="max-width: 600px;">Start automating your hostel today. Choose
                    a plan that grows with your business.</p>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-card h-100">
                        ...
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="mb-3"><i class="fa-solid fa-check text-success me-2"></i> Automated Invoicing
                            </li>
                        ...
                        <a href="{{ route('register') }}" class="btn btn-light btn-lg w-100 fw-bold rounded-pill">Get
                            Started</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-card popular h-100">
                        ...
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="mb-3"><i class="fa-solid fa-check text-success me-2"></i> Financial Reports</li>
                            <li class="mb-3"><i class="fa-solid fa-check text-success me-2"></i> Every 3rd Branch Free
                            </li>
                            <li class="mb-3"><i class="fa-solid fa-check text-success me-2"></i> Priority Support</li>
                        </ul>
                        <a href="{{ route('register') }}" class="btn btn-neon btn-lg w-100 rounded-pill">Start Free
                            Trial</a>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer text-center">
        <div class="container">
            ...
            <p class="small mt-1">Powered by <span class="text-white fw-bold">SatvScript</span>.</p>
        </div>
    </footer>
