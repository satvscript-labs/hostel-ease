        ...
        <div class="d-flex flex-column gap-4">
            ...
            <div class="premium-panel p-4">
                ...
                <div class="row g-3 row-cols-2 row-cols-md-3">
                    <div class="col">
                        <div class="{{ ($paymentSummary['outstanding'] ?? 0) > 0 ? 'bg-danger-subtle border-danger-subtle' : 'bg-light border-light' }} rounded-3 p-3 border d-flex flex-column justify-content-center">
                            <div class="{{ ($paymentSummary['outstanding'] ?? 0) > 0 ? 'text-danger' : 'text-muted' }} small fw-bold text-uppercase mb-1" style="font-size: 0.75rem;">Outstanding</div>
                            <div class="fs-5 fw-bold lh-1 {{ ($paymentSummary['outstanding'] ?? 0) > 0 ? 'text-danger' : 'text-dark' }}">{{ hostelease_money($paymentSummary['outstanding'] ?? 0) }}</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="bg-info-subtle bg-opacity-50 rounded-3 p-3 border border-info-subtle d-flex flex-column justify-content-center">
                            <div class="text-info-emphasis small fw-bold text-uppercase mb-1" style="font-size: 0.75rem;">Credits</div>
                            <div class="fs-5 fw-bold lh-1 text-info-emphasis">{{ hostelease_money($student->credit_balance ?? 0) }}</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="bg-success-subtle bg-opacity-50 rounded-3 p-3 border border-success-subtle d-flex flex-column justify-content-center">
                            <div class="text-success small fw-bold text-uppercase mb-1" style="font-size: 0.75rem;">Total Paid</div>
                            <div class="fs-5 fw-bold lh-1 text-success">{{ hostelease_money($paymentSummary['total_paid'] ?? 0) }}</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="bg-warning-subtle bg-opacity-50 rounded-3 p-3 border border-warning-subtle d-flex flex-column justify-content-center">
                            <div class="text-warning-emphasis small fw-bold text-uppercase mb-1" style="font-size: 0.75rem;">Pocket Money</div>
                            <div class="fs-5 fw-bold lh-1 text-warning-emphasis">{{ hostelease_money($pocketBalance ?? 0) }}</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="bg-primary-subtle bg-opacity-50 rounded-3 p-3 border border-primary-subtle position-relative d-flex flex-column justify-content-center">
                            <div class="text-primary-emphasis small fw-bold text-uppercase mb-1" style="font-size: 0.75rem;">Security Deposit</div>
                            <div class="fs-5 fw-bold lh-1 text-primary-emphasis">{{ hostelease_money($student->securityDeposits()->where('status', 'collected')->sum('amount')) }}</div>
